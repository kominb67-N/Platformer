// Fallback declarations for specular properties (added to fix missing symbol errors)
// If your shader already provides these, you can remove these lines.
float _Reflectivity = 1.0;
float4 _SpecularColor = float4(1.0, 1.0, 1.0, 1.0);
float _SpecularPower = 1.0;
